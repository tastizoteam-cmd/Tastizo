...
export const createSupportTicket = async (deliveryPartnerId, payload) => {
    ...
    try {
        const { notifyAdminsSafely } = await import('../../../../core/notifications/firebase.service.js');
        void notifyAdminsSafely({
            title: '🎫 New Support Ticket (Delivery)',
            body: `A delivery partner has created a new support ticket regarding ${ticket.category}.`,
            data: {
                type: 'support_ticket',
                subType: 'delivery_partner',
        ...
        // eslint-disable-next-line no-console
        console.error('Failed to notify admins of delivery support ticket:', err);
    }
